<?php
    ...
    class Paypal extends Conectar{
        ...
        public function get_paypal($arrayDetalle,$vent_total,$vent_id){
            ...
            $redirectUrls->setReturnUrl("http://localhost:8082/paypal_php_mysql/view/invoice/?vent_id=".$vent_id)
                        ->setCancelUrl("http://localhost:8082/paypal_php_mysql/view/cart");
